            ...
            switch (rDirection) {
                ...
                case CENTER_RIGHT:
                    switch (rOrientation) {
                        ...
                        case EAST: {
                            // idea: if far enough right, turn right
                            // else if not that far, reverse and turn right
                ...
                case CENTER_LEFT:
                    switch (rOrientation) {
                        ...
                        case WEST: {
                            // idea: if far enough left, turn left
                            // else if not that far, reverse and turn left
