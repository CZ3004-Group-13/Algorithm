...
import simulator.Wavefront.EndlessLoopException;
import simulator.Wavefront.NoPathFoundException;
 
public class UI extends JFrame implements IUICallback, ActionListener{
    ...
    private static final int GRIDSIZEY = 22;
